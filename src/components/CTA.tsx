...
export default function CTA() {
  return (
    <section
      id="contact"
      className="py-40 px-8 md:px-16 bg-gradient-to-br from-forest to-forest-deep text-center relative overflow-hidden"
    >
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(201,169,98,0.1)_0%,transparent_70%)] pointer-events-none" />
