...
const programOverview = [
  ...
  { label: "Loan Term", value: "12 months - 18 months" },
  ...
  { label: "Liquidity Requirement", value: "10% of the rehab budget + cash to close (equity shortage may be added)" },
  { label: "Cost Basis", value: "Seasoned Refinance: As-Is Appraised Value + Remaining Budget | Unseasoned Refinance: Lesser of (Purchase Price or As-Is Value) + Remaining Budget" },
...
export default function RehabPage() {
  return (
    <>
      <Navbar currentPage="/products/rehab" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-white/80 text-xl leading-relaxed mb-8">
                  Truly Renovation Loans allow investors to execute business plans ranging from light renovations
                  to complex property transformations, with financing terms structured to fit their needs.
                </p>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <a href="/renovation-loan-matrix.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center gap-2">
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <h2 className="section-title">Renovation Loan Overview</h2>
          ...
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="/renovation-loan-matrix.pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary">
                  View Matrix
                </a>
              </div>
            </motion.div>
